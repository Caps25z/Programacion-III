...
private void limpiarCampos() {
    ...
    private void initComponents() {
        ...
        tableClientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Apellido", "Telefono", "Email", "Genero", "Direccion"
            }
        ));
...
try {
    ...
    String genero = txtGenero.getText();  // Antes era txtCiudad
    String email = txtEmail.getText();    // Antes era txtGmail
    String telefono = txtTelefono.getText();

    // Guardar cliente con los nuevos nombres
    int resultado = cliente.guardarCliente(nombre, apellido, direccion, telefono, email, genero);
        ...
        try {
            ...
            if (rs != null) {
                while (rs.next()) {
                    ...
                    model.addRow(new Object[]{id, nombre, apellido, direccion, telefono,genero,email});
                }
